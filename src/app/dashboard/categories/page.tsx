...
// Categories — standalone page (was a section inside Settings). Manages
// the expense + income category taxonomy. Two side-by-side columns on
// desktop, stacked on mobile. Delete is guarded by a transaction-usage
