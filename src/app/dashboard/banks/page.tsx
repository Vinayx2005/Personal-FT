...
// Banks / Cards — standalone page (was a section inside Settings). Manages
// the list of funding accounts, their opening + current balance, the
// balance-change history, and add / edit / delete. Numbers auto-derive
